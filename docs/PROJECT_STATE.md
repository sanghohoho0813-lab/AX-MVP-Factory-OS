...
## 마찰 제거(처음 쓰는 50대 기준) — feature 브랜치 `claude/zero-friction-ux-v2` (2026-09-08)
- **Preview 까지. main 병합·Production 배포 없음** (대표 지시 §60).
...
- 사람이 할 일: Preview 에서 한 번 써 보고 어디서 멈추는지 알려 주면 그 자리만 고친다.
