            ...
            <tr key={item.id} className="border-b border-slate-100 align-top">
              <td className="px-2.5 py-2 break-keep text-slate-800">
                <div className="flex flex-wrap items-center gap-1.5">
                  ...
                  {item.internalOnly && (
                    <span className="inline-flex items-center rounded border border-danger-200 bg-danger-50 px-1.5 py-0.5 text-[0.875rem] font-semibold text-danger-600">
                      내부 전용
                    </span>
                  )}
                </div>
              ...
              <td className="px-2.5 py-2 whitespace-nowrap">
                {item.verified ? (
                  <span className="inline-flex items-center rounded-md border border-success-200 bg-success-50 px-2 py-0.5 text-[0.875rem] font-medium text-success-700">
                    확인
                  </span>
                ) : (
