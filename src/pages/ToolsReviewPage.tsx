...
const WHY: Record<string, string[]> = {
  'sales-kit': [
    '원본(법인컨설팅 세일즈 OS) 14화면이 그대로 돈다. D-114 부터 운영 OS 의 영업 › 영업 관리 로 하나씩 옮기는 중이다.',
    '옮긴 것: 영업 단계(잠재 고객 → 1차 · 2차 미팅 → 3차 클로징 → 계약, 보류 · 이탈) · 영업 보드 · 새 잠재고객 · 업체별 영업 기록(단계 · 유입 · 소개자 · 관심사 · 예상 수임료).',
    '다음에 옮길 것: 미팅 준비 1·2·3차 대본 · 리드 점수 · 전략 추천, 상품 가격표 40종(원본 가격 그대로) · 견적 · 제안서 · 월납 제안, 전략 라이브러리.',
